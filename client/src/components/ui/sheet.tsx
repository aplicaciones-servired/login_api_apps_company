import { Root, Trigger, Portal, Close, Overlay, Title, Description, Content } from '@radix-ui/react-dialog'
...
function SheetContent({ className, children, side = 'right', ...props }: React.ComponentProps<typeof Content> & {
